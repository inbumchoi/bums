			...
			<div id="contentWrapper">
				<div class="page-title title-1">
					<div class="container">
						<div class="row">
							<div class="cell-12">
								<h1 class="fx" data-animate="fadeInLeft"> 회원 <span>가입</span></h1>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="container">
						<div class="row">
							<div class="cell-7 contact-form fx" data-animate="fadeInLeft">
			    				<h3 class="block-head">회원가입  양식</h3>
			    				<form action="#" id="reg_form">
			    					<div class="form-input">
			    						<label>아이디<span class="red">*</span></label><input type="text" name="userId" required>
			    					</div>
			    					<div class="form-input">
			    						<label>비밀번호<span class="red">*</span></label><input type="text" name="password" required>
			    					</div>
			    					<div class="form-input">
			    						<label>비밀번호 확인<span class="red">*</span></label><input type="text" name="password_check" required>
			    					</div>
			    					<div class="form-input">
			    						<label>이름<span class="red">*</span></label><input type="text" name="userName" required>
			    					</div>
			    					<div class="form-input">
			    						<label>E-Mail<span class="red">*</span></label><input type="text" name="email" required>
			    					</div>
			    					<div class="form-input">
			    						<label>홈페이지<span class="red">*</span></label><input type="text" type="homePage" required>
			    					</div>
			    					<div class="form-input">
			    						<label>주소<span class="red">*</span></label>
			    						<input type="text" id="address1" required> 
			    						<input type="text" id="address2" required>
			    						<input type="text" id="postcode1" required>
			    						<input type="text" id="postcode2" required>
